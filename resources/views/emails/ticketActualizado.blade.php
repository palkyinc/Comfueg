...
<body>
    <h3>Actualización de pedido de asistencia técnica:</h3>
    ...
    <table>
        ...
        <tbody>
                ...
                @foreach ($issue->issues_update as $item)
                    <tr>
                        <td colspan="3" class="titulo centrado">Actualizado por: {{$item->relUsuario->name}}, el: 
                            {{$item->created_at}}</td>
                    </tr>
                    <tr>
                        <td colspan="3" class="justificado">{{$item->descripcion}}</td>
                    </tr>
                @endforeach
        </tbody>
    </table>
